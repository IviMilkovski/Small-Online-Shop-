...
@section('description') Everything you should know about us and our shop. @endsection
@section('keywords') shop, about, store, clothes @endsection
    ...
    <section class="bg-success py-5">
        <div class="container">
            <div class="row align-items-center py-5">
                ...
                <div class="col-md-2">
                    <img src="{{asset('assets/img/about-hero2.png')}}" alt="About Hero">
                </div>
            </div>
        </div>
    </section>
