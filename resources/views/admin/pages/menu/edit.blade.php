...
@section('title')
    Admin | Lil'Shop | Menu | Edit
@endsection

@section('description')
    Online shop - Edit navigation menu links
@endsection

@section('keywords')
    admin panel, navigation menu links, edit
@endsection
                                    ...
                                    <form action="{{ route('menus.update',  $menu->id) }}" method="POST" class="contact-form update-navlink">
                                        ...
                                        <div class="row d-flex justify-content-center align-content-between">
                                            ...
                                            <div class="col-sm-8 mb-2 mt-2 d-flex justify-content-center">
                                                ...
                                                <a href="{{ route('admin.menu') }}" class="btn btn-dark ml-3"><i class="fa fa-arrow-left"></i>  Back to list of menus</a>
                                            </div>
                                        </div>
                                    </form>
                                    @if ($errors->any())
